...
export default class Main extends Component {
    ...
    handleLabelChange = (e, i) => {
        window.setting.ajaxInterceptor_rules[i].value = e.target.value;
    };
                                    ...
                                    (
                                        ...
                                        <Panel
                                            ...
                                            header={
                                                ...
                                                >
                                                    <Input.Group compact style={{ width: '80%' }}>
                                                        <Input
                                                            placeholder='Tag'
                                                            style={{ width: '20%' }}
                                                            defaultValue={label}
                                                        ...
                                                        <Select
                                                            ...
                                                            style={{ width: '25%' }}
                                                            onChange={e =>
                                                                this.handleFilterTypeChange(e, i)
                                                            }
                                                        >
